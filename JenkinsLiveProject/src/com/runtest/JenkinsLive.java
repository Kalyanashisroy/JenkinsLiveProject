...
public class JenkinsLive {
	...
	//Build now
	public WebDriver ClickOnBuildNow(WebDriver driver) throws InterruptedException {
		WebElement eleJenkinsLivePro=driver.findElement(By.xpath("//a[contains(text(),'JenkinsLiveProjects')]"));
		eleJenkinsLivePro.click();		
		WebElement elebuildnow=driver.findElement(By.xpath("//a[contains(text(),'Build Now')]"));
		elebuildnow.click();
		Thread.sleep(5000);
		
		/*java.util.List<WebElement> elementsBuild=driver.findElements(By.xpath("//a[@class='tip model-link inside build-link display-name zws-inserted']"));
		System.out.println("Number of elements:"+elementsBuild.size());
		*/	
		java.util.List<WebElement> elementsBuild1=driver.findElements(By.xpath("//img[@title='Success > Console Output']"));
		System.out.println("Number of elements:"+elementsBuild1.size());
		/*for(int i=0;i<elementsBuild1.size();i++) {
			
			System.out.println(elementsBuild1.get(i).getAttribute("tooltip"));
		}*/
		for(WebElement ele:elementsBuild1) {
			ele.click();
			Thread.sleep(2000);
			WebElement eleBuildValue=driver.findElement(By.xpath("//pre[@class='console-output']"));
			System.out.println(eleBuildValue.getText());
			//System.out.println(ele.getText());
		}
		
		/*for(WebElement ele:elementsBuild) {
				System.out.println(ele.getText());
		}*/
		/*WebElement eleconsole=driver.findElement(By.xpath("//pre[@class='console-output']"));
		System.out.println(eleconsole.getTagName());
		*/
